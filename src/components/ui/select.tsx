...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ...
    className={cn(
      ...
      "focus:outline-none focus:ring-2 focus:ring-ring/40 focus:ring-offset-0 focus:border-primary/60",
      "disabled:cursor-not-allowed disabled:opacity-50 [&>span]:line-clamp-1",
      "data-[state=open]:border-primary/60 data-[state=open]:ring-2 data-[state=open]:ring-ring/30",
      className,
    )}
    {...props}
  >
...
>(({ className, ...props }, ref) => (
  <SelectPrimitive.Label
    ref={ref}
    className={cn(
      "py-1.5 px-3 text-xs font-semibold text-muted-foreground uppercase tracking-wider",
      className,
    )}
    {...props}
  />
